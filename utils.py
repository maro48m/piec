...
files_in_use = {}
print('init locks')
file_locks = {"piec.hist": uasyncio.Lock(),
              "termometr.hist": uasyncio.Lock(),
              "log.txt": uasyncio.Lock()}
print('locks', file_locks)
config = {}
